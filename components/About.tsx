...
<div className="flex items-start w-full">
  <div className="relative w-full">
    ...
    {/* TEXT BLOCK shifted using transform */}
    <div className="relative translate-x-[100px]">
      ...
      <p className="mt-6 text-gray-800 leading-relaxed text-sm sm:text-base md:text-lg italic">
